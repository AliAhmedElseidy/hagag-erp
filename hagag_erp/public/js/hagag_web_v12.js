...
document.addEventListener('DOMContentLoaded', function() {
    if (window.location.pathname === '/login') {
        ...
        if (loginForm && !document.querySelector('.custom-login-footer')) {
            var footerHTML = `
            <div class="custom-login-footer">
                <img src="https://erp.hagagco.com/files/470573.png" alt="Logo">
                <p class="company-name">مؤسسة نورة مهنا أبوزيد للمقاولات</p>
                <a href="https://wa.me/966569589664" target="_blank" class="wa-btn">
            ...
            loginForm.insertAdjacentHTML('beforeend', footerHTML);
        }
    }
});
